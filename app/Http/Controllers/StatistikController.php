...
class StatistikController extends Controller
{
    ...
    private function getStatistikData()
    {
        ...
        $pendapatanMinumandingin = Transaksi::whereHas('transaksiDetails.menu.kategori', function ($query) {
            $query->where('nama_kategori', 'Minuman Dingin');
        })->sum('total_bayar');
        $pendapatanMinumanpanas = Transaksi::whereHas('transaksiDetails.menu.kategori', function ($query) {
            $query->where('nama_kategori', 'Minuman Panas');
        })->sum('total_bayar');
        ...
        return compact(
            ...
            'produkTerlaris',
            'pendapatanMakanan',
            'pendapatanMinumandingin',
            'pendapatanMinumanpanas',
            'kinerjaUser'
        );
    }
